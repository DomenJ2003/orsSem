...
menuKalkulator.add_command(label="Kalkulator", command=lambda: openKalkulator(window))
menuKalkulator.add_command(label="Datoteka", command=lambda: openDatKalkulator(window))
menubar.add_cascade(label="Kalkulator", menu=menuKalkulator)

menuPretvorbe = Menu(menubar, tearoff=0)
menuPretvorbe.add_command(label="Pretvorbe", command=lambda: openPretvorbe(window))
menuPretvorbe.add_command(label="Datoteka", command=lambda: openDatPretvorbe(window))
menubar.add_cascade(label="Pretvorbe", menu=menuPretvorbe)

menuLogicne = Menu(menubar, tearoff=0)
menuLogicne.add_command(label="Logicne Funkcije", command=lambda: openLogicne(window))
menuLogicne.add_command(label="Datoteka", command=lambda: openDatLogicne(window))
